function [states, branches_indexed, emissions_1, emissions_2]= JSWCgenerate(L,trCube,emCube_1,emCube_2,Trellis_Index_io)
    ...
    states = zeros(1,L);
    emissions_1 = zeros(1,numEmission*L);
    emissions_2 = zeros(1,numEmission*L);
