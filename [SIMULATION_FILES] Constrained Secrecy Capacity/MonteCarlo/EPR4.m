%% EPR4 Channel Information Rate (Markov Input)
clear all;close all;clc;
Input_Size = 1e4 ;
MeanIter=5;
cnTime  = 1 ;
SNRdBInterval=(5.5);
FrequencyResponse=[1 1 -1 -1];
...
%           0,0,0.7588218629485850,0.24117813705141300,0,0,0,0; % =================SecCapacity=0.0717
...
%  ==========================================EPR4/EPR4======================================================
%                                            =========
% Trans_Pr=[0.586244468064954,0.4137555319350470,0,0,0,0,0,0; % *Optimal  Distribution
%           0,0,0.690535274110710,0.3094647258892880,0,0,0,0; % IUD SecureRATE:0.18583
%           0,0,0,0,0.4292200740368710,0.570779925963130,0,0; % =====================
%           0,0,0,0,0,0,0.517080450842380,0.4829195491576190; % Main Channel
%           0.4883045332239320,0.511695466776069,0,0,0,0,0,0; % EPR4 / SNR:5.0dB/Rate:0.71295
%           0,0,0.5906532684995780,0.409346731500421,0,0,0,0; % =================SecCapacity=0.18188
%           0,0,0,0,0.2910356756198710,0.708964324380127,0,0; % Eave Channel
%           0,0,0,0,0,0,0.432788732605628,0.567211267394372]; % EPR4 / SNR:2.5dB/Rate:0.53107
% ============================================================================================================
% Trans_Pr=[0.5820938328442990,0.417906167155701,0,0,0,0,0,0; % *Optimal  Distribution
%           0,0,0.7130106463752110,0.286989353624790,0,0,0,0; % IUD SecureRATE:0.18583
%           0,0,0,0,0.4443418500258800,0.555658149974120,0,0; % =====================
%           0,0,0,0,0,0,0.5156010785247780,0.484398921475223; % Main Channel
%           0.519409046785728,0.4805909532142730,0,0,0,0,0,0; % EPR4 / SNR:5.0dB/Rate:0.72332
%           0,0,0.590242272805213,0.4097577271947880,0,0,0,0; % =================SecCapacity=0.19053
%           0,0,0,0,0.325452089090568,0.6745479109094340,0,0; % Eave Channel
%           0,0,0,0,0,0,0.449509478013308,0.550490521986692]; % EPR4 / SNR:2.5dB/Rate:0.53279
% ============================================================================================================
 %%
